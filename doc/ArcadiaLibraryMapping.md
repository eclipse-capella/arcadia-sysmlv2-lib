...
| None | Type::isAbstract / abstract modifier | isAbstract | Used for Actors. Kind of a "REC/RPL' thing to create abstract actors and reuse among actors - linked to Generalized Components | Rarely used. See how REC/RPL are managed in v2 | N/A | N/A |
